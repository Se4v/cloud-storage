...
import {
  getDriveOverview,
  getDriveUsageBreakdown,
  getEnterpriseDriveDetails,
  getPersonalDriveDetails
} from '@/api/driveStat'
...
const loadOverview = async () => {
  try {
    const data = await getDriveOverview()
    totalQuota.value = data.totalQuota
    allocatedQuota.value = data.allocatedQuota
    usedQuota.value = data.usedQuota
...
const loadBreakdown = async () => {
  try {
    const data = await getDriveUsageBreakdown()
    enterpriseQuota.value = data.enterpriseQuota
    personalQuota.value = data.personalQuota
  } catch (error) {
...
const loadEnterpriseData = async () => {
  try {
    const data = await getEnterpriseDriveDetails()
    enterpriseTableData.value = data
  } catch (error) {
...
const loadPersonalData = async () => {
  try {
    const data = await getPersonalDriveDetails()
    personalTableData.value = data
  } catch (error) {
